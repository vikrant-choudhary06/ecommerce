            ...
            {slide?.image ? (
              <>
                ...
                <div className="absolute inset-0 flex items-center justify-start px-8 md:px-20">
                  <div className="max-w-2xl space-y-4 md:space-y-6 text-zinc-900">
                    <span className="text-xs md:text-sm font-medium tracking-widest text-zinc-700 uppercase animate-in fade-in slide-in-from-bottom-2 duration-700">
                      {slide?.subTitle || "Test the Quality"}
                    </span>
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-zinc-900 leading-tight uppercase animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
                    ...
                    <div className="pt-2 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                      <button
                        ...
                        className="bg-white text-[#d9a014] font-semibold text-xs tracking-widest px-8 py-3 rounded-md uppercase hover:shadow-md hover:bg-zinc-50 transition-all font-sans"
                      >
              ...
              <div
                className={`w-full h-full flex flex-col justify-center items-start text-left px-8 md:px-20 ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 relative flex items-center justify-center">
              ...
              <div className="w-[80%] aspect-[4/5] overflow-hidden bg-muted rounded-xl shadow-lg relative">
                <img
                  src="https://images.unsplash.com/photo-1590156546746-c208c2b41985?w=600&q=80"
